...
const RentalRequestPage: React.FC = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#111" }}>
      <div className="rental-request-form-box card" style={{ minWidth: 340, maxWidth: 440, width: "100%", marginTop: 32 }}>
        <h2 style={{ textAlign: "center", marginBottom: 24, color: '#b388ff', fontWeight: 700 }}>Kölcsönzési igény</h2>
